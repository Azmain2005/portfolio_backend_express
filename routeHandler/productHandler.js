...
// routeHandler/productHandler.js cleanup
router.get('/', async (req, res) => {
  try {
    // Only populate 'categorie' because the other fields don't exist in your schema
...
// Update logic: Use findByIdAndUpdate properly
